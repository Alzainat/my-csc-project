<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="space-y-3">
            <button
                type="button"
                class="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-300 rounded-md hover:bg-gray-50 transition">
            ...
            <button
                type="button"
                class="w-full flex items-center justify-center gap-2 py-2.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
            ...
            <button
                type="button"
                class="w-full flex items-center justify-center gap-2 py-2.5 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
